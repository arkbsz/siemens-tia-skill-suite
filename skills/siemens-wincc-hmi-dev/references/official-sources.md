...
Use these first when confirming what WinCC automation can and cannot do.

- [Openness - TIA Portal](https://docs.tia.siemens.cloud/r/en-us/v20/installation/licensing/licensing-of-wincc-unified-options/openness): WinCC Unified licensing notes and Openness capability boundary.
- [Introduction - WinCC](https://docs.tia.siemens.cloud/r/en-us/v21/sivarc-openness/introduction?contentId=W_lc7vsEdR2dV6~H4GVxhQ): SiVArc Openness entry point and required APIs.
- [SiVArc Openness - WinCC](https://docs.tia.siemens.cloud/r/en-us/v21/sivarc-openness): rule-driven HMI generation surface.
