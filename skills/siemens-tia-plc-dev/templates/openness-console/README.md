...
- Override `TiaPortalVersionMajor`, `TiaPortalRoot`, or `TiaPortalPublicApiRoot` when targeting `V18` through `V21`.
...
```powershell
__PROJECT_NAME__.exe list-plcs --project "D:\path\to\project.ap17"
