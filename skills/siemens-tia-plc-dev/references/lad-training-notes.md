...
- A real-project free-write validation exists for `FC1_报警程序块` network 15 in `D:\plc\手动程序`, and it passed clone import, compile, and post-import export with `ImportExitCode=0`, `CompileExitCode=0`, and `ExportExitCode=0` on July 22, 2026.
